...
if __name__ == "__main__":
    ...
    json_already = os.path.isfile(image_doc_json) and os.path.getsize(image_doc_json)

    if already_md and json_already:
        print("Data already processesed. Skipping process_data() function.")
    else:
        process_data(pdf_folder, md_folder, image_folder, image_doc_json, table_doc_path)

    # Load data into ChromaDB
    text_db, image_db, table_db = load_data(pdf_folder, md_folder, image_folder, image_doc_json, table_doc_path, chroma_path, embedding_fn)
