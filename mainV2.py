...
if __name__ == "__main__":
    ...
    text_db = ChromaDB.create_chroma_db(text_docs, chroma_path, name="text_docs")
    image_db = ChromaDB.create_chroma_db(image_docs, chroma_path, name="image_docs")
    table_db = ChromaDB.create_chroma_db(table_docs, chroma_path, name="table_docs")
    ...
    answer, images_res, tables_res, docs, metadatas, distances = generate_answer_with_source(text_db, image_db, table_db, query=question)
